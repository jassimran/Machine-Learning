...
public class BasicBehavior {
	...
	public BasicBehavior(){		
		...
		gwdg.setObstacleInCell(4,3);
		gwdg.setObstacleInCell(6,3);
		gwdg.setObstacleInCell(0,3);
		gwdg.setObstacleInCell(2,3);
		gwdg.setObstacleInCell(3,0);
		gwdg.setObstacleInCell(3,2);
		gwdg.setObstacleInCell(3,3);
		gwdg.setObstacleInCell(3,4);
		gwdg.setObstacleInCell(3,6);
